...
export const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-[#050505] flex items-center justify-center relative overflow-hidden">
            ...
            <div className="absolute bottom-[-20%] left-[-10%] w-[50%] h-[50%] bg-amber-600/5 blur-[100px] rounded-full pointer-events-none" />
            ...
            <div className="w-full max-w-md p-8 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/5 shadow-2xl relative z-10">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-slate-500 text-xs font-bold tracking-[0.2em] uppercase mt-1">SecureVision Command Grid</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button 
                        type="submit" 
                        className="w-full bg-gradient-to-r from-orange-500 to-amber-600 text-white font-bold py-3 rounded-xl shadow-lg shadow-orange-500/20 hover:shadow-orange-500/40 hover:scale-[1.02] transition-all duration-300 flex items-center justify-center gap-2 mt-4"
                    >
                        ACCESS TERMINAL
                        <ArrowRight size={16} />
                    </button>
                    ...
                    <div className="text-center mt-6">
                        <Link to="/signup" className="text-xs text-slate-500 hover:text-orange-400 transition-colors font-bold tracking-wide">
                            CREATE NEW ACCOUNT
                        </Link>
                    </div>
                </form>
